...
#+BEGIN_SRC emacs-lisp
(let ((backtrace-buffer-rx (rx bos "*Backtrace*" eos)))
  (add-to-list 'bmacs-popups backtrace-buffer-rx)
  (add-to-list 'display-buffer-alist
             `(,backtrace-buffer-rx
               (display-buffer-in-side-window)
               (reusable-frames . visible)
...
#+BEGIN_SRC emacs-lisp
(let ((vcdiff-buffer-rx (rx bos "*vc-diff*" eos)))
  (add-to-list 'bmacs-popups vcdiff-buffer-rx)
  (add-to-list 'display-buffer-alist
               `(,vcdiff-buffer-rx
                 (display-buffer-reuse-window
                  display-buffer-in-side-window)
 ...
 :nv [C-S-backspace] #'hs-show-all
  ...
  (:leader
    ...
    (:desc "git"
      ...
      :desc "Smerge Hydra"                 :nv "m" #'+hydra-smerge/body
