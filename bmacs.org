...
- [[#configuration][Configuration]]
  ...
  - [[#git][Git]]
    ...
    - [[#smerge][smerge]]
    - [[#magithub-disabled][magithub (disabled)]]
  - [[#ui-1][UI]]
...
(use-package doom-themes
  ...
  :config
  ;(set! :theme 'doom-one)
  (load-file (expand-file-name "~/.emacs.d/doom-nord-custom-theme.el"))
  (load-theme 'doom-nord-custom t)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun bmacs/alternate-buffer-old (&optional window)
...
(custom-set-faces
  '(diff-hl-change         ((t (:foreground "#ECCC87"))))
  '(git-gutter:modified    ((t (:foreground "#ECCC87"))))
  '(git-gutter+-modified   ((t (:foreground "#ECCC87"))))
  '(git-gutter-fr:modified ((t (:foreground "#ECCC87")))))
...
(custom-set-faces
 '(evil-goggles-delete-face           ((t (:foreground "#ff6655"))))
 '(evil-goggles-paste-face            ((t (:foreground "#99bb66"))))
 '(evil-goggles-yank-face             ((t (:foreground "#5E81AC"))))
 '(evil-goggles-undo-redo-remove-face ((t (:foreground "#ff6655"))))
 '(evil-goggles-undo-redo-add-face    ((t (:foreground "#99bb66"))))
 '(evil-goggles-undo-redo-change-face ((t (:foreground "#5E81AC")))))

;; Override org mode colors
(custom-set-faces
 '(org-level-1              ((t :foreground "#80A0C2" :inherit nil :height 1.2)))
 '(org-level-2              ((t :foreground "#B58DAE" :inherit nil :height 1.1)))
 '(org-level-3              ((t :foreground "#8EBCBB" :inherit nil :height 1.1)))
 '(org-level-4              ((t :foreground "#ECCC87" :inherit nil :height 1.1)))
 '(org-level-5              ((t :foreground "#D2876D" :inherit nil :height 1.1))))
#+END_SRC
