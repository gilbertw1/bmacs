...
(setq-default
 ...
 ;; TODO: Revisit later and remove if no ill effects
 ;; sentence-end-double-space nil ; consider period with a single space afterwards end of sentance
...
#+BEGIN_SRC emacs-lisp
(setq-default
 ;; TODO: revisit and remove if default of 5 is satisfactory
 ;; hscroll-margin 1                    ; how many columns from edge until scrolling start
 ;; TODO: revisit and remove if default of center point is acceptable
 ;; hscroll-step 1                      ; only scroll by a single column
