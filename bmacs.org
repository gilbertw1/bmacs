...
- [[#configuration][Configuration]]
  ...
  - [[#git][Git]]
    ...
    - [[#git-link][git-link]]
    - [[#evil-magit---todo-do-i-still-want-this-experiment-with-default-keybinds][evil-magit - TODO: do I still want this, experiment with default keybinds]]
  - [[#ui-1][UI]]
...
redefines its keys every time `eshell-mode' is enabled."
  ...
  (add-to-list 'bmacs-escapable-popups (rx bos "*eshell*" eos))
#+END_SRC
