...
(setq load-prefer-newer t
      ...
      package-user-dir (expand-file-name "elpa" bmacs-packages-dir))
...
(add-hook 'prog-mode #'bmacs|enable-line-numbers)
(add-hook 'text-mode #'bmacs|enable-line-numbers)
(add-hook 'conf-mode #'bmacs|enable-line-numbers)
#+END_SRC
    ...
    (let ((all-the-icons-scale-factor 1.45)
      ...
      (mapc (lambda (btn)
            ...
            `(("Homepage" "mark-github"
               (browse-url "https://github.com/gilbertw/bmacs"))
